...
function M.parse(arg)
   ...
   cmd:text('Options:')
    ------------ General options --------------------
   cmd:option('-data',       '/home/yanzhaowu/research/video_detection/Charades_small/Charades_v1_rgb', 'Path to dataset')
   cmd:option('-trainfile',  '/home/yanzhaowu/research/video_detection/Charades_small/Charades_v1_train.csv', 'Path to training annotations')
   cmd:option('-testfile',   '/home/yanzhaowu/research/video_detection/Charades_small/Charades_v1_test.csv', 'Path to testing annotations')
